export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      ...
      <p>
        At Fileflex, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          data we collect, please contact us at devmaster.ams@gmail.com.
        </p>
      </div>

      <p>
        By using Fileflex, you agree to the practices outlined in this Privacy
